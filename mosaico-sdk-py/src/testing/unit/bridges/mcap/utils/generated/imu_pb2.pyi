...
class Imu(_message.Message):
    ...
    RAW_DIAGNOSTIC_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        ...
        orientation: _Optional[_Union[_common_pb2.Quaternion, _Mapping]] = ...,
        angular_velocity: _Optional[_Union[_common_pb2.Vector3, _Mapping]] = ...,
        linear_acceleration: _Optional[_Union[_common_pb2.Vector3, _Mapping]] = ...,
        linear_acceleration_covariance: _Optional[_Iterable[float]] = ...,
        status: _Optional[_Union[ImuStatus, str]] = ...,
        calibrated: bool = ...,
        sequence: _Optional[int] = ...,
        temperature_millideg: _Optional[int] = ...,
        uptime_ns: _Optional[int] = ...,
        drift_estimate: _Optional[float] = ...,
        raw_diagnostic: _Optional[bytes] = ...,
    ) -> None: ...
