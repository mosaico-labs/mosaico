...
#                         pa.struct(
#                             [
#                                 pa.field("sec", pa.int64(), nullable=True),
#                                 pa.field("nanosec", pa.int64(), nullable=True),
#                             ]
#                         ),
#                         nullable=True,
#                     ),
#                     pa.field("frame_id", pa.string(), nullable=True),
#                 ]
#             ),
#             nullable=True,
#         ),
...
#                     pa.field("w", pa.float64(), nullable=True),
#                 ]
#             ),
#             nullable=True,
#         ),
...
#         ),
#         pa.field(
#             "linear_acceleration_covariance", pa.list_(pa.float64()), nullable=True
#         ),
#         pa.field("status", pa.int64(), nullable=True),
#         pa.field("calibrated", pa.bool_(), nullable=True),
#         pa.field("sequence", pa.int64(), nullable=True),
#         pa.field("temperature_millideg", pa.int64(), nullable=True),
#         pa.field("uptime_ns", pa.int64(), nullable=True),
#         pa.field("drift_estimate", pa.float64(), nullable=True),
#         pa.field("diagnostic_note", pa.string(), nullable=True),
#     ]
# )
...
#                     pa.field("altitude", pa.float64(), nullable=True),
#                 ]
#             ),
#             nullable=True,
#         ),
#         pa.field("position_covariance", pa.list_(pa.float64()), nullable=True),
#         pa.field("fix_type", pa.int64(), nullable=True),
#         pa.field("satellites_visible", pa.int64(), nullable=True),
#         pa.field("satellites_used", pa.int64(), nullable=True),
#         pa.field("differential", pa.bool_(), nullable=True),
#         pa.field("horizontal_accuracy", pa.float64(), nullable=True),
#         pa.field("vertical_accuracy", pa.float64(), nullable=True),
#         pa.field("utc_time_micros", pa.int64(), nullable=True),
#         pa.field("station_id", pa.string(), nullable=True),
#         pa.field("active_satellite_ids", pa.list_(pa.string()), nullable=True),
#     ]
# )
...
#             nullable=True,
#         ),
#         pa.field("magnetic_field_covariance", pa.list_(pa.float64()), nullable=True),
#         pa.field("temperature_celsius", pa.float64(), nullable=True),
#         pa.field("sensor_id", pa.int64(), nullable=True),
#         pa.field("saturated", pa.bool_(), nullable=True),
#         pa.field("calibration_notes", pa.list_(pa.string()), nullable=True),
#         pa.field(
#             "readings",
#             pa.list_(
#                 pa.struct(
#                     [
#                         pa.field("axis", pa.string(), nullable=True),
...
#             nullable=True,
#         ),
#         pa.field("hardware_revision", pa.int64(), nullable=True),
#         pa.field("raw_counter", pa.int64(), nullable=True),
#     ]
# )
...
VARIANT_EXPECTED_STRUCT = pa.struct(
    [
        ...
        pa.field("int_value", pa.int64(), nullable=True),
