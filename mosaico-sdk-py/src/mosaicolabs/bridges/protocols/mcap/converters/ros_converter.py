...
class RosMsgSchemaConverter(McapSchemaConverter):
    ...
    def _typesdict_to_schema(cls, typesdict: Typesdict, msgtype: str) -> pa.StructType:
        ...
        for field_name, field_desc in fields_def:
            ...
            if node_type is Nodetype.BASE:
                ...
                pyarrow_type = cls._ROS_2_PYARROW_TYPE[ros_type]
                ...
                composed_field = pa.field(
                    field_name, cls._typesdict_to_schema(typesdict, content)
                )
                ...
                if item_node_type is Nodetype.BASE:  # simple type
                    ...
                    list_field = cls._ROS_2_PYARROW_TYPE[ros_type]

                elif item_node_type is Nodetype.NAME and isinstance(
                    item_content, str
                ):  # complex type
                    list_field = pa.field(
                        field_name, cls._typesdict_to_schema(typesdict, item_content)
                    )
    ...
    def _convert(cls, mcap_schema: Schema) -> pa.StructType:
        ...
        msgtype: str = mcap_schema.name

        return cls.convert_rosmsg(msgdef, msgtype)

    @classmethod
    def convert_rosmsg(cls, msgdef: str, msgtype: str) -> pa.StructType:
        ...
        Example:
            ...
            Calling::
                ...
                RosMsgConverter.convert_rosmsg(geometry_msg_pose_msgdef, "geometry_msgs/msg/Pose")
        ...
        return cls._typesdict_to_schema(typesdict, msgtype)
