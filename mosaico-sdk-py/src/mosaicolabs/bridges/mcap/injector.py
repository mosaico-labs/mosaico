...
class MCAPInjector:
    ...
    **Core Workflow Architecture:**
    ...
    Attributes:
        cfg (MCAPInjectionConfig): The active configuration settings.
    ...
    def _get_default_adapter(
        self, schema_name: str, schema_encoding: str
    ) -> Optional[Type[MCAPAdapterBase]]:
        """
        Chached lookup for MCAP Adapters.

        Args:
            msg_type (str): The ROS message type string (e.g., "sensor_msgs/msg/Image").

        Returns:
            Optional[Type[MCAPAdapterBase]]:The adapter class if found, otherwise None.
        """

        return MCAPBridge.get_default_adapter(schema_name, schema_encoding)
    ...
    def _process_message(
        ...
        Args:
            mcap_msg (MCAPMessage): The ROS message to process.
