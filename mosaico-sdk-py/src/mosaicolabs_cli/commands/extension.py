...
def list_extensions(
    ...
    if not extensions:
        console.print("[yellow]No external extensions discovered in your $PATH.[/yellow]")
        console.print("To add an extension, place an executable named 'mosaico-<command>' in your PATH.")
        return
