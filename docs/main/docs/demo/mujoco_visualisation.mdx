...
The daemon must be running with data from the [ROS Ingestion](./ros_ingestion) demo. MuJoCo is not included in the default SDK dependencies — install it before running:
