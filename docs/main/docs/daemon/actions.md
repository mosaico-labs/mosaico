...
| `topic_filter_intersect` | Clusters several topics of the same sequence independently, then streams the time windows where all of them hold matching data simultaneously. See [Filtering](filtering.md#intersection). | `read` |
