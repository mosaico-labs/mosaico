...
sidebar_position: 4
description: "Runnable example showing how to search the Mosaico catalog using query builders. Covers fuzzy topic name matching with QueryTopic, filtering by Ontology type with ontology_tag(), multi-domain queries combining QueryOntologyCatalog and the .Q proxy, and slicing results for event replay."
---
...
```python title="Fuzzy topic name search"
