...
- `match` operator with support for a **custom simplified regex**, extended to sequence name and topic name. ([#622](https://github.com/mosaico-labs/mosaico/pull/622), [#543](https://github.com/mosaico-labs/mosaico/pull/543))
...
- **Glob patterns `*` and `**`** enabled for user metadata queries. ([#547](https://github.com/mosaico-labs/mosaico/pull/547))
- **Input validation** for user metadata keys. ([#560](https://github.com/mosaico-labs/mosaico/pull/560))
...
- `cleanup` and `server` split into separate subcommands. ([#639](https://github.com/mosaico-labs/mosaico/pull/639))
...
- Field **ontology tag** is now validated. ([#539](https://github.com/mosaico-labs/mosaico/pull/539))
...
- Session UUID replaced by the `locator` in `TopicMetadataProps`. ([#584](https://github.com/mosaico-labs/mosaico/pull/584))
